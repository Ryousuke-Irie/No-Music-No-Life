...
public class StageScript_18_No08 : StageScript
{
    ...
    public override void SetStickData()
    {
        ...
        //SetStick(num++, (sp + (p * (t * 138))) * vel);       // 連打
        ...
        //SetStick(num++, (sp + (p * (t * 170))) * vel);        // 連打
        ...
        //SetStick(num++, (sp + (p * (t * 178))) * vel);        // 連打
        ...
        //SetStick(num++, (sp + (p * (t * 186))) * vel);        // 連打
        ...
        //SetStick(num++, (sp + (p * (t * 194))) * vel);        // 連打
        ...
        //SetStick(num++, (sp + (p * (t * 234))) * vel);        // 連打↓
        ...
        //SetStick(num++, (sp + (p * (t * 331))) * vel);
        //SetStick(num++, (sp + (p * (t * 332))) * vel);
        //SetStick(num++, (sp + (p * (t * 333))) * vel);
        //SetStick(num++, (sp + (p * (t * 334))) * vel);
        //SetStick(num++, (sp + (p * (t * 335))) * vel);
        //SetStick(num++, (sp + (p * (t * 336))) * vel);
        //SetStick(num++, (sp + (p * (t * 337))) * vel);
        //SetStick(num++, (sp + (p * (t * 338))) * vel);
        //SetStick(num++, (sp + (p * (t * 339))) * vel);
        //SetStick(num++, (sp + (p * (t * 340))) * vel);
        //SetStick(num++, (sp + (p * (t * 341))) * vel);
        //SetStick(num++, (sp + (p * (t * 342))) * vel);
        //SetStick(num++, (sp + (p * (t * 343))) * vel);
        //SetStick(num++, (sp + (p * (t * 344))) * vel);
        //SetStick(num++, (sp + (p * (t * 345))) * vel);
        //SetStick(num++, (sp + (p * (t * 346))) * vel);
        //SetStick(num++, (sp + (p * (t * 347))) * vel);
        //SetStick(num++, (sp + (p * (t * 348))) * vel);
        //SetStick(num++, (sp + (p * (t * 349))) * vel);
        //SetStick(num++, (sp + (p * (t * 350))) * vel);
        //SetStick(num++, (sp + (p * (t * 351))) * vel);
        //SetStick(num++, (sp + (p * (t * 352))) * vel);
        //SetStick(num++, (sp + (p * (t * 353))) * vel);
        //SetStick(num++, (sp + (p * (t * 354))) * vel);
        //SetStick(num++, (sp + (p * (t * 355))) * vel);
        //SetStick(num++, (sp + (p * (t * 356))) * vel);
        //SetStick(num++, (sp + (p * (t * 357))) * vel);
        //SetStick(num++, (sp + (p * (t * 358))) * vel);
        //SetStick(num++, (sp + (p * (t * 359))) * vel);
        //SetStick(num++, (sp + (p * (t * 360))) * vel);
        //SetStick(num++, (sp + (p * (t * 361))) * vel);
        //SetStick(num++, (sp + (p * (t * 362))) * vel);
        //SetStick(num++, (sp + (p * (t * 363))) * vel);
        //SetStick(num++, (sp + (p * (t * 364))) * vel);
        //SetStick(num++, (sp + (p * (t * 365))) * vel);
        //SetStick(num++, (sp + (p * (t * 366))) * vel);
        //SetStick(num++, (sp + (p * (t * 367))) * vel);
        //SetStick(num++, (sp + (p * (t * 368))) * vel);
        //SetStick(num++, (sp + (p * (t * 369))) * vel);
        //SetStick(num++, (sp + (p * (t * 370))) * vel);
        //SetStick(num++, (sp + (p * (t * 371))) * vel);
        //SetStick(num++, (sp + (p * (t * 372))) * vel);
        //SetStick(num++, (sp + (p * (t * 373))) * vel);
        //SetStick(num++, (sp + (p * (t * 374))) * vel);
        //SetStick(num++, (sp + (p * (t * 375))) * vel);
        //SetStick(num++, (sp + (p * (t * 376))) * vel);
        //SetStick(num++, (sp + (p * (t * 377))) * vel);
        //SetStick(num++, (sp + (p * (t * 378))) * vel);
        //SetStick(num++, (sp + (p * (t * 379))) * vel);
        //SetStick(num++, (sp + (p * (t * 380))) * vel);
        //SetStick(num++, (sp + (p * (t * 381))) * vel);
        //SetStick(num++, (sp + (p * (t * 382))) * vel);
        //SetStick(num++, (sp + (p * (t * 383))) * vel);
        //SetStick(num++, (sp + (p * (t * 384))) * vel);
        //SetStick(num++, (sp + (p * (t * 385))) * vel);
        //SetStick(num++, (sp + (p * (t * 386))) * vel);
        //SetStick(num++, (sp + (p * (t * 387))) * vel);
        //SetStick(num++, (sp + (p * (t * 388))) * vel);
        //SetStick(num++, (sp + (p * (t * 389))) * vel);
        //SetStick(num++, (sp + (p * (t * 390))) * vel);
        //SetStick(num++, (sp + (p * (t * 391))) * vel);
        //SetStick(num++, (sp + (p * (t * 392))) * vel);
        //SetStick(num++, (sp + (p * (t * 393))) * vel);
        //SetStick(num++, (sp + (p * (t * 394))) * vel);
        //SetStick(num++, (sp + (p * (t * 395))) * vel);
        //SetStick(num++, (sp + (p * (t * 396))) * vel);
        //SetStick(num++, (sp + (p * (t * 397))) * vel);
        //SetStick(num++, (sp + (p * (t * 398))) * vel);
        //SetStick(num++, (sp + (p * (t * 399))) * vel);
        //SetStick(num++, (sp + (p * (t * 400))) * vel);
