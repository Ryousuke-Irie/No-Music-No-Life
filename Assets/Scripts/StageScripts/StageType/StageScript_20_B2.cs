...
public class StageScript_20_B2 : StageScript
{
    ...
    public override void SetObstacleData()
    {
        ...
        SetObstacle(num++, (sp + (p * (t * 2))) * vel - error, 0 * updown, obstacleTypeA);
        ...
        SetObstacle(num++, (sp + (p * (t * 13))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 15))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 17))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 20))) * vel - error, 0 * updown, obstacleTypeA);
