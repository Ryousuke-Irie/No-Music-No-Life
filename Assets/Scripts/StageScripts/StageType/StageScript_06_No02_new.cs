...
public class StageScript_06_No02_new : StageScript
{
    public GameObject enemyTypeA;
    public GameObject obstacleTypeA;
    public float bpm = 90.0f;      // bpm 
    private int Max = 0;
    ...
    // Enemyコピペゾーン --------------------
        ...
        SetEnemy(num++, (sp + (p * (t * 10))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 13))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 21))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 24))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 46))) * vel - error, 1 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 68))) * vel - error, -1 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 98))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 107))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 111))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 112))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 116))) * vel - error, -1 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 139))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 140))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 141))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 145))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 147))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 157))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 162))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 167))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 168))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 169))) * vel - error, 1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 181))) * vel - error, -1 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 182))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 183))) * vel - error, 1 * updown, enemyTypeA);
    ...
    public override void SetObstacleData()
    {
        ...
        SetObstacle(num++, (sp + (p * (t * 19))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 26))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 29))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 31))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 32))) * vel - error, 1 * updown, obstacleTypeA);
        ...
        SetObstacle(num++, (sp + (p * (t * 53))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 61))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 64))) * vel - error, 0 * updown, obstacleTypeA);
        ...
        SetObstacle(num++, (sp + (p * (t * 92))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 100))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 102))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 104))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 113))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 114))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 118))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 119))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 126))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 127))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 130))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 149))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 150))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 152))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 153))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 157))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 158))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 160))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 161))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 164))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 171))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 172))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 175))) * vel - error, 0 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 176))) * vel - error, 1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 188))) * vel - error, -1 * updown, obstacleTypeA);
        SetObstacle(num++, (sp + (p * (t * 189))) * vel - error, 1 * updown, obstacleTypeA);
