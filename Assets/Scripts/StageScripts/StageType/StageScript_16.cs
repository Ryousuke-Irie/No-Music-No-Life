...
public class StageScript_16 : StageScript
{
    ...
    public override void SetEnemyData()
    {
        ...
        SetEnemy(num++, (sp + (p * (t * 1))) * vel - error, 0 * updown, enemyTypeA);
		...
		SetEnemy(num++, (sp + (p * (t * 15))) * vel - error, 0 * updown, enemyTypeA);
		SetEnemy(num++, (sp + (p * (t * 16))) * vel - error, 0 * updown, enemyTypeA);
		SetEnemy(num++, (sp + (p * (t * 17))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 18))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 19))) * vel - error, 1 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 21))) * vel - error, 0 * updown, enemyTypeA);



        SetEnemy(num++, (sp + (p * (t * 25))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 35))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 37))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 38))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 39))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 41))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 43))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 52))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 53))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 54))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 55))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 57))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 59))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 61))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 67))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 69))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 71))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 77))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 78))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 79))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 81))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 83))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 85))) * vel - error, 0 * updown, enemyTypeA);



        SetEnemy(num++, (sp + (p * (t * 89))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 91))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 100))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 103))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 105))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 106))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 107))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 109))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 111))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 112))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 119))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 121))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 124))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 135))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 137))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 139))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 141))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 143))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 145))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 151))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 153))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 155))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 157))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 159))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 160))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 165))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 167))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 169))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 171))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 172))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 179))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 193))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 194))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 195))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 196))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 197))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 199))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 204))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 207))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 210))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 213))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 214))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 215))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 217))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 219))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 221))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 222))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 223))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 224))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 227))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 229))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 231))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 233))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 236))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 245))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 248))) * vel - error, 0 * updown, enemyTypeA);


        SetEnemy(num++, (sp + (p * (t * 251))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 253))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 255))) * vel - error, 0 * updown, enemyTypeA);
        ...
        SetEnemy(num++, (sp + (p * (t * 263))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 265))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 267))) * vel - error, 0 * updown, enemyTypeA);

        SetEnemy(num++, (sp + (p * (t * 269))) * vel - error, 0 * updown, enemyTypeA);
        SetEnemy(num++, (sp + (p * (t * 270))) * vel - error, 0 * updown, enemyTypeA);
